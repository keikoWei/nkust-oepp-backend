    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/api/carousel/public/**", "/api/news/public/**", "/api/news/file/**", "/api/courses/public/**", "/api/courses/file/**", "/api/training-plans/public/**", "/actuator/**", "/error").permitAll()
                // 超級管理員可以訪問所有路徑
