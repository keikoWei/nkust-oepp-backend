...
public class CourseResponse {
    ...
    public CourseResponse(Course course) {
        ...
        this.centerRole = course.getCenterRole().getCode();
        this.centerRoleName = course.getCenterRole().getName();
        this.title = course.getTitle();
        this.contentHtml = course.getContentHtml();
        this.mainImageUrl = course.getMainImageUrl();
        this.sortOrder = course.getSortOrder();
        this.isEnabled = course.getIsEnabled();
        this.publishTime = course.getPublishTime();
        ...
        try {
            if (course.getImageUrls() != null && !course.getImageUrls().isEmpty()) {
                this.imageUrls = objectMapper.readValue(course.getImageUrls(), new TypeReference<List<String>>() {});
            } else {
        ...
        try {
            if (course.getFilePaths() != null && !course.getFilePaths().isEmpty()) {
                this.filePaths = objectMapper.readValue(course.getFilePaths(), new TypeReference<List<String>>() {});
            } else {
